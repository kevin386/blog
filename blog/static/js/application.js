...
ValidationDefaultOptions.prototype = {
  onSubmit : true, //鏄惁鐩戝惉form鐨剆ubmit浜嬩欢
  stopOnFirst : false, //琛ㄥ崟楠岃瘉鏃跺仠鐣欏湪绗竴涓獙璇佺殑鍦版柟,涓嶇户缁獙璇佷笅鍘�
  immediate : true, //鏄惁瀹炴椂妫€鏌ユ暟鎹殑鍚堟硶鎬�
  focusOnError : true, //鏄惁鍑洪敊鏃跺皢鍏夋爣鎸囬拡绉诲埌鍑洪敊鐨勮緭鍏ユ涓�
  useTitles : false, //鏄惁浣跨敤input鐨則itle灞炴€т綔涓哄嚭閿欐椂鐨勬彁绀轰俊鎭�
  onFormValidate : function(result, form) {},//Form楠岃瘉鏃剁殑鍥炶皟鍑芥暟
  onElementValidate : function(result, elm) {} //鏌愪釜input楠岃瘉鏃剁殑鍥炶皟鍑芥暟
};

var ValidatorDefaultOptions = function(){};
ValidatorDefaultOptions.prototype = {
  ignoreEmptyValue : true, //鏄惁蹇界暐绌哄€�
  depends : [] //鐩稿叧渚濊禆椤�
};
...
ValidationUtils = {
  ...
  // 閫氳繃classname浼犻€掔殑鍙傛暟蹇呴』閫氳繃'-'鍒嗛殧鍚勪釜鍙傛暟
  // 杩斿洖鍊煎寘鍚竴涓弬鏁皊ingleArgument,渚�:validate-pattern-/[a-c]/gi,singleArgument鍊间负/[a-c]/gi
...
Validator.messages = {
  'validation-failed' : '楠岃瘉澶辫触.',
  'required' : '璇峰～鍐欏€�.',
  'validate-number' : '璇峰～鍐欐湁鏁堢殑鏁板瓧.',
  'validate-digits' : '璇峰～鍐欐暟瀛�.',
  'validate-alpha' : '璇峰～鍐欒嫳鏂囧瓧姣�.',
  'validate-alphanum' : '璇峰～鍐欒嫳鏂囧瓧姣嶆垨鏄暟瀛�,鍏跺畠瀛楃鏄笉鍏佽鐨�.',
  'validate-email' : '璇峰～鍐欐湁鏁堢殑閭欢鍦板潃,鍙兘浣跨敤a-z A-Z 0-9 _ . -\',濡� username@example.com銆� ',
  'validate-url' : '璇峰～鍐欐湁鏁堢殑URL鍦板潃.',
  'validate-currency-dollar' : 'Please enter a valid $ amount. For example $100.00 .',
  'validate-one-required' : '鍦ㄤ笂闈㈤€夐」鑷冲皯閫夋嫨涓€涓�.',
  'validate-integer' : '璇峰～鍐欐纭殑鏁存暟',
  'validate-pattern' : '濉啓鐨勫€间笉鍖归厤',
  'validate-ip' : '璇峰～鍐欐纭殑IP鍦板潃',
  'min-value' : '鏈€灏忓€间负%s',
  'max-value' : '鏈€澶у€间负%s',
  'min-length' : '鏈€灏忛暱搴︿负%s,褰撳墠闀垮害涓�%s.',
  'max-length' : '鏈€澶ч暱搴︿负%s,褰撳墠闀垮害涓�%s.',
  'int-range' : '濉啓鍊煎簲璇ヤ负 %s 鑷� %s 鐨勬暣鏁�',
  'float-range' : '濉啓鍊煎簲璇ヤ负 %s 鑷� %s 鐨勬暟瀛�',
  'length-range' : '濉啓鍊肩殑闀垮害搴旇鍦� %s 鑷� %s 涔嬮棿,褰撳墠闀垮害涓�%s',
  'equals' : '涓ゆ濉啓涓嶄竴鑷�,璇烽噸鏂板～鍐�',
  'less-than' : '璇峰～鍐欏皬浜庡墠闈㈢殑鍊�',
  'great-than' : '璇峰～鍐欏ぇ浜庡墠闈㈢殑鍊�',
  'validate-date' : '璇峰～鍐欐湁鏁堢殑鏃ユ湡,鏍煎紡涓� %s. 渚嬪:%s.',
  'validate-file' : function(v,elm,args,metadata) {
    return ValidationUtils.format("鏂囦欢绫诲瀷搴旇涓篬%s]鍏朵腑涔嬩竴",[args.join(',')]);
  },
  'validate-id-number' : '璇峰～鍐欏悎娉曠殑韬唤璇佸彿鐮�',
  'validate-chinese' : '璇峰～鍐欎腑鏂�',
  'validate-phone' : '璇峰～鍐欐纭殑鐢佃瘽鍙风爜,濡�:021-87654321,褰撳墠闀垮害涓�%s.',
  'validate-mobile-phone' : '璇峰～鍐欐纭殑鎵嬫満鍙风爜,褰撳墠闀垮害涓�%s.',
  'validate-zip' : '璇峰～鍐欐湁鏁堢殑閭斂缂栫爜',
  'validate-qq' : '璇峰～鍐欐湁鏁堢殑QQ鍙风爜.',
  'validate-richeditor' : '璇峰～鍐欏€�.',
  'validate-combobox' : '璇峰～鍐欏€兼垨閫夊彇鍓嶉潰鐨勯€夐」.',
  'max-tag' : '璇峰～鍐�1-%s涓猅ag.'
};

Validator.bad_words=[/fuck/i,/shit/i,/QQ缇�/i,/MSN缇�/i,/姹�(鍔﹟鏁�)/,/(璺獆瑁�)姹�/,/鎬ユ€鎴戝緢鎬绱ф€ュ姹�/,/鍦ㄧ嚎绛�/,/鏁�(鍛絴鎴憒鎬鏁�)/,/鎬�(!|锛�)/,/(楂樻墜|楂樹汉|澶ц櫨|澶т緺|杈句汉|鍓嶈緢|蹇潵|娌℃湁浜�)(鎸囩偣|瑙ｇ瓟|甯繖|甯府|鎸囨暀|璧愭暀|鎻愮偣|涓嶅悵璧愭暀|鍒板摢)/,/(鎴戞槸|甯府)(鏂版墜|灏忓紵|鑿滈笩)/,/甯府蹇�/, /涓囧垎鐏€�/, /鎴戦《|椤朵笂鍘粅濂借创瑕侀《|甯《|鐪嬬湅鍏坾椤朵竴涓�/,/鏈�*娌℃湁浜�(鍥炵瓟|甯繖|鍏虫敞|鐭ラ亾鍟妡鍥炲)/,/鏁欎富|瑁匓|瑁�13/,/鍏虫敞(ing|涓�)/i,/鏀惰棌鍏�/,/鍏堟敹钘�/,/鏀惰棌浜�/,/鍥句功鍏艰亴浣滆€�/,/璋㈣阿妤间富/,/浼犳櫤鎾/,/FineReport/i];
...
Validation.addAllThese([
  ...
  ['bad-words', function(v) {
      for (var i=0; i < Validator.bad_words.length; i++) {
        ...
        if (m) {
          alert("ITeye鍙戣创鎻愮ず\n\nITeye缃戠珯涓嶅厑璁告偍浣跨敤 \"" + m[0] + "\" 杩欐牱鐨勮瘝姹囧彂璐达紒\n\n鎮ㄥ緢鍙兘杩濆弽浜嗙綉绔欒鍒欙紝璇蜂粩缁嗛槄璇诲苟閬靛畧缃戠珯瑙勫垯锛屽惁鍒欏皢琚墸鍒嗗垹璐淬€俓n\n");
          return false;
        }}
      return true;		
    }],
  ...
  ['max-tag', function(v, elm, args){
    return v.replace(/^\s+|\s+$/g, '').split(/,\s*|锛孿s*/).length <= parseInt(args[0]);
  }]
]);
...
var attachment_template = new Template('<table><tr><th>鏂囦欢:</th><td><span>#{filename}</span><span class="more"><a href="#" class="delete">鍒犻櫎</a></span><div class="clear"></div></td></tr><tr><th>鎻忚堪:</th><td><textarea name="attachments[][remark]" cols="" rows=""></textarea></td></tr></table>');
...
function addAttachmentDiv(ele, max_size) {
  if (!$A(['jpg','jpeg','bmp','png','gif','rar','zip', 'tar', 'gz', 'jar', 'war', 'bz2', '7z']).any(function(extName){return new RegExp('\\.'+extName+'$','i').test(ele.value);})){
    alert("濡傛灉鎮ㄤ笂浼犲浘鐗囷紝璇蜂笂浼燡PG銆丅MP銆丳NG鎴栬€匞IF鏍煎紡鐨勫浘鐗嘰n濡傛灉鎮ㄤ笂浼犻檮浠讹紝璇峰厛鍘嬬缉鍐嶄笂浼�");
      return false;
  }
...
function addPictureDiv(ele, max_size, tags) {
  if (!$A(['jpg','jpeg','bmp','png','gif']).any(function(extName){return new RegExp('\\.'+extName+'$','i').test(ele.value);})){
    alert("鎮ㄤ笂浼犵殑鍥剧墖鏍煎紡涓嶆敮鎸侊紝璇锋偍涓婁紶JPG銆丅MP銆丳NG鎴栬€匞IF鏍煎紡鐨勫浘鐗�");
    return false;
  }
  ...
  var tag_select = "";
  if(tags.length > 0) {
    var tag_select = "<select onchange='Element.previous($(this)).value = this.value;'><option value=''>閫夋嫨宸叉湁鏍囩</option>";
    for (var i = 0; i < tags.length; i++)
      tag_select += "<option value='" + tags[i] + "'>" + tags[i] + "</option>";
    tag_select += "</select>";
  }
  var div = new Element("div").update("<ul><li>鏂囦欢: " + ele.value + " <a href='#' onclick='removePictureDiv(this, \"" + ele.id + "\");return false;'>鍒犻櫎</a></li><li>鍚嶇О: <input type='text' name='pictures[][name]' value='" + file_name + "' size='50' class='text'/></li><li>鎻忚堪: <textarea name='pictures[][description]' style='width:400px;height:80px;'></textarea></li></ul>");
...
function extract_tag_list(value) {
    var tags = value.trim().split(/,\s*|锛孿s*/).without('');
    highlight_suggested_tags(tags);
    tag_list = tags.map(function(tag) { 
        return "<span>" + tag + "</span>";
    }).join('');
    if (!tag_list.empty()) {
        tag_list = '褰撳墠鏍囩锛�' + tag_list;
    }
...
function trigger_suggested_tag() {
  ...
  if (this.hasClassName('added')) {
    ...
    tag_list_input.value = current_value.split(/,\s*|锛孿s*/).findAll(function(tag){
      tag = tag.trim();
...
function del_vote_option(vote_option){
  ...
  if(vote_option_url){
    if(confirm('鎱庣敤,濡傛姇绁ㄩ€夐」涓嬫湁寰堝鎶曠エ,浼氬垹闄ゅ叾鎵€鏈夋姇绁�,鑰屽鍔犳湇鍔″櫒鍘嬪姏')){
  ...
  (function(){
    ...
    var Render = {
      summary_names : function(names) {
        if (names.length > 3) {
          return new Template('#{names}鍜屽彟澶�#{other}浜�').evaluate({
            'names' : names.clone().splice(0,3).join('锛�'), 'other' : names.length - 3
          });
        } else {
          return names.join('锛�');
        }
      ...
      template_blog_comment : function(notification) {
        this.render_comments_common_template(notification, 'blog', '鍥炲浜嗘偍鐨勫崥瀹㈡枃绔�');
      },

      template_blog_comment_other : function(notification) {
        this.render_comments_common_template(notification, 'blog', '鍥炲浜嗘偍鍥炲杩囩殑鍗氬鏂囩珷');
      },

      template_topic_post : function(notification) {
        this.render_comments_common_template(notification, 'topic', '鍥炲浜嗘偍鐨勮鍧涗富棰�', 'posts');
      },

      template_topic_post_other : function(notification) {
        this.render_comments_common_template(notification, 'topic', '鍥炲浜嗘偍鍥炲杩囩殑璁哄潧涓婚', 'posts');
      },

      template_group_topic_post : function(notification) {
        this.render_comments_common_template(notification, 'topic', '鍥炲浜嗘偍鐨勭兢缁勪富棰�', 'posts');
      },

      template_group_topic_post_other : function(notification) {
        this.render_comments_common_template(notification, 'topic', '鍥炲浜嗘偍鍥炲杩囩殑缇ょ粍涓婚', 'posts');
      },

      template_news_comment: function(notification) {
        this.render_comments_common_template(notification, 'news', '璇勮浜嗘偍鐨勮祫璁枃绔�');
      },

      template_news_comment_other: function(notification) {
        this.render_comments_common_template(notification, 'news', '璇勮浜嗘偍璇勮杩囩殑璧勮鏂囩珷');
      },

      template_essence_comment: function(notification) {
        this.render_comments_common_template(notification, 'essence', '璇勮浜嗘偍鐨勭簿鍗庢枃绔�');
      },

      template_essence_comment_other: function(notification) {
        this.render_comments_common_template(notification, 'essence', '璇勮浜嗘偍璇勮杩囩殑绮惧崕鏂囩珷');
      },

      template_problem_solution: function(notification) {
        this.render_comments_common_template(notification, 'problem', '鍥炵瓟浜嗘偍鐨勯棶棰�', 'solutions');
      },

      template_problem_solution_other: function(notification) {
        this.render_comments_common_template(notification, 'problem', '鍥炵瓟浜嗘偍鍥炵瓟杩囩殑闂', 'solutions');
      },

      template_problem_solution_follow: function(notification) {
        this.render_comments_common_template(notification, 'problem', '鍥炵瓟浜嗘偍鍏虫敞鐨勯棶棰�', 'solutions');
      },

      template_problem_comment: function(notification) {
        this.render_comments_common_template(notification, 'problem', '璇勮浜嗘偍鐨勯棶棰�', 'comments');
      },

      template_problem_comment_follow: function(notification) {
        this.render_comments_common_template(notification, 'problem', '璇勮浜嗘偍鍏虫敞鐨勯棶棰�', 'comments');
      },

      template_problem_follow: function(notification) {
        this.render_comments_common_template(notification, 'problem', '鍏虫敞浜嗘偍鐨勯棶棰�', 'follows');
      },

      template_solution_comment: function(notification) {
        this.render_comments_common_template(notification, 'solution', '璇勮浜嗘偍鐨勫洖绛�', 'comments');
      },

      template_event_comment: function(notification) {
        this.render_comments_common_template(notification, 'event', '璇勮浜嗘偍鐨勬椿鍔�', 'comments');
      },

      template_event_comment_other: function(notification) {
        this.render_comments_common_template(notification, 'event', '璇勮浜嗘偍璇勮杩囩殑娲诲姩', 'comments');
      },

      template_event_comment_member: function(notification) {
        this.render_comments_common_template(notification, 'event', '璇勮浜嗘偍鍙備笌鐨勬椿鍔�', 'comments');
      },

      template_page_comment: function(notification) {
        this.render_comments_common_template(notification, 'page', '璇勮浜嗘偍鐨勭煡璇嗗簱', 'comments');
      },

      template_page_comment_other: function(notification) {
        this.render_comments_common_template(notification, 'page', '璇勮浜嗘偍璇勮杩囩殑鐭ヨ瘑搴�', 'comments');
      },
      ...
      render_comments_common_template : function(notification, subject, title, comments) {
        ...
        notification[comments].each(function(comment, index) {
          if (index > 2) {
            var template = new Template('<div class="notification_detail_item clearfix" style="display:none;"><span class="left"><a href="#{user_url}" target="_blank">#{user_name}</a>锛�#{body} </span><span class="time">#{time}</span></div>')
          } else {
            var template = new Template('<div class="notification_detail_item clearfix"><span class="left"><a href="#{user_url}" target="_blank">#{user_name}</a>锛�#{body}</span> <span class="time">#{time}</span></div>')
          }
          ...
          if (comment.url) {
            var comment_link = ' <a target="_blank" href="' + comment.url + '">鏌ョ湅</a>';
          ...
          if (index === 2 && notification[comments].length > 3) {
            ...
            var show_all = new Element('a', {'class': 'show_all'}).update('鏌ョ湅鍙﹀'+ (notification[comments].length - 3) + '鏉�' );
      ...
      template_subscription: function(notification) {
        ...
        var summary = new Template('#{names}鍏虫敞浜嗘偍').evaluate({
    ...
    function init_detail_paginate() {
      ...
      var prev = new Element('a', {id : 'prev_button'}).update('鈥� 涓婁竴鏉�');
      var next = new Element('a', {id : 'next_button'}).update('涓嬩竴鏉� 鈥�');
    ...
    function init_notification_menu() {
      ...
      notifications_summary.update('<div class="menu_title clearfix"><span class="title">鎻愰啋</span><span class="all"><a href="http://my.iteye.com/notifications">鏌ョ湅鎵€鏈� 禄</a></span></div>');
      ...
      var return_button = new Element('span', {'class' : 'return left'}).update('芦 杩斿洖閫氱煡鍒楄〃');
    ...
    function update_notifications_menu() {
      ...
      if (notifications.length > 0) {
        ...
        notifications_summary.insert('<div class="notification_summary">褰撳墠娌℃湁鎻愰啋淇℃伅</div>');
      }
    }
    ...
    function refresh_unread_count(count) {
      ...
      if (count > 0) {
        notifications_count.addClassName('new_notice').writeAttribute('title', '鏈�' + count + '鏉℃湭璇绘秷鎭�');
      } else {
        notifications_count.removeClassName('new_notice').writeAttribute('title', '娌℃湁鏈娑堟伅');
      }
    }
    ...
    function update_notifications() {
      var loading = new Element('div', {id : 'notifications_loading'}).update('杞藉叆涓�...');
...
document.observe("dom:loaded", function() {(function() {
    ...
    var AskPageAction = Class.create({
      ...
      //妫€娴嬪綋鍓嶆槸鍚︽湁灞傚湪鏄剧ず涓�,浠ョ‘瀹氭槸鍚﹁繍琛宑lean鍜宻how浠诲姟
      //杩斿洖false琛ㄧず鏈変换鍔¤繘琛屼腑,涓嶆竻鐞嗗拰鏄剧ず
      //this._is_show琛ㄧず鏄惁鏄剧ず鏂扮殑灞�
      _check: function() {
        this._is_show = false;
        ...
        case 'dropdown':
          ...
          if (dropdown_status == undefined) { //褰撳墠娌℃湁涓嬫媺灞�
            this._is_show = true;
          } else if (dropdown_status == 'showed' && dropdown_current.event_element() != this._event_element) { //褰撳墠鏈変笅鎷夊眰,浣嗛渶瑕佹樉绀烘柊鐨勪笅鎷夊眰
            this._is_show = true;
          } else if (dropdown_status == 'showing') { //鏈変换鍔¤繘琛屼腑
            return false;
          }
          break;
        case 'popup':
    ...
    var CommentAction = Class.create(PageAction, {
      ...
      show: function() {
        ...
        new Ajax.Request(url, {
          ...
          onSuccess: function(transport) {
            ...
            this._event_element.appendChild(document.createTextNode('鏀惰捣璇勮'));
      ...
      hide: function() {
        ...
        if (comments_count > 0) comments_count_text = document.createTextNode(comments_count + '鏉¤瘎璁�');
        else comments_count_text = document.createTextNode('娣诲姞璇勮');
